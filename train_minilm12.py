...
if not bert_model_cached:
    ...
    bert_conf.embedding_model = "all-MiniLM-L12-v2"
    ...
    common.save_dataframe(publications_bert_train, "publications_bert_train_minilm12")
    common.save_dataframe(publications_bert_cv, "publications_bert_cv_minilm12")
    common.save_dataframe(publications_bert_test, "publications_bert_test_minilm12")
else:
    publications_bert_train = common.load_dataframe("publications_bert_train_minilm12")
    publications_bert_cv = common.load_dataframe("publications_bert_cv_minilm12")
    publications_bert_test = common.load_dataframe("publications_bert_test_minilm12")
...
# results = common.load_pickle("results_roberta_1655360012_87.pickle")
results = []
filename = f"results_minilm12_{int(time.time())}"
i = 0
for pca_num_components, normalize_features, metric in tqdm(choices):
    ...
    bert_conf.fpr_samples_from = 0
    bert_conf.fpr_samples_to = 1
    bert_conf.fpr_samples_count = 10000
