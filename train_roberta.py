...
if not bert_model_cached:
    ...
    bert_conf.embedding_model = "all-distilroberta-v1"
    ...
    common.save_dataframe(publications_bert_train, "publications_bert_train_roberta")
    common.save_dataframe(publications_bert_cv, "publications_bert_cv_roberta")
    common.save_dataframe(publications_bert_test, "publications_bert_test_roberta")
else:
    publications_bert_train = common.load_dataframe("publications_bert_train_roberta")
    publications_bert_cv = common.load_dataframe("publications_bert_cv_roberta")
    publications_bert_test = common.load_dataframe("publications_bert_test_roberta")
...
filename = f"results_roberta_{int(time.time())}"
i = 0
